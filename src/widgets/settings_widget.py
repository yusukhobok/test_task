...
class SettingsWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.l_main = self.add_float_item("Уровень главного лепестка ДНА (l<sub>main</sub>), °",
                                          default_options['l_main'], default_options['l_main_min'],
                                          default_options['l_main_max'], 3, 1)
        self.l_side = self.add_float_item("Уровень бокового лепестка ДНА (l<sub>side</sub>), °",
